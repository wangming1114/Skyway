  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Skyway 后台管理框架</h2>
        <p>
          Skyway 管理系统可用于所有的 Web 应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA 等等，您也可以进行深度定制。所有前端后台代码封装过后精简易上手，同时支持移动客户端访问。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="Cloudy"
            plain
            @click="goTarget('https://github.com/skyway/Skyway-Vue')"
            >访问码云</el-button
          >
          <el-button
            icon="HomeFilled"
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="https://github.com/skyway/Skyway-Vue"
                target="_blank"
                >https://github.com/skyway/Skyway-Vue</el-link
              >
            </p>
            <p>
