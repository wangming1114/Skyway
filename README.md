...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">Skyway v3.9.1</h1>
...
Skyway 是一套快速开发平台，前端采用 Vue、Element UI，后端采用 Spring Boot、Spring Security、Redis & Jwt。
...
项目地址：https://github.com/skyway/Skyway-Vue
