package com.skyway.common.utils.file;
...
import com.skyway.common.exception.file.FileNameLengthLimitExceededException;
import com.skyway.common.exception.file.FileSizeLimitExceededException;
import com.skyway.common.exception.file.InvalidExtensionException;
...
import com.skyway.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = SkywayConfig.getProfile();
    ...
    {
        int dirLastIndex = SkywayConfig.getProfile().length() + 1;
